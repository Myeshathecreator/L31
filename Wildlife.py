...
background_image = pygame.transform.scale(
    pygame.image.load(r"C:\Users\user\Desktop\Python\L31\Tiger background.png").convert(),
    (SCREEN_WIDTH, SCREEN_HEIGHT)
)

wildlife_image = pygame.transform.scale(
    pygame.image.load(r"C:\Users\user\Desktop\Python\L31\Tiger.png").convert_alpha(),
    (220, 220)
)
